...
> Referencia canonica del verbo espanol **ganar**.
> URL: https://ganar.com.ar
> Pronunciacion: /ga'nar/ (IPA: ɡaˈnaɾ)

Verbo transitivo del espanol. Estados posibles. Eleccion propia.

## Definicion

**ganar** — verbo transitivo (intransitivo en acepcion 2).

## Acepciones

1. Adquirir caudal o aumentarlo con cualquier genero de comercio, industria o trabajo.
   - Ejemplo: Ganarse la vida. Ganar el sustento.
2. Obtener lo que se disputa en un juego, batalla, oposicion o pleito.
   - Ejemplo: Ganar la partida. Ganar un juicio.
3. Conquistar, tomar posesion de algo ajeno o recuperar lo propio.
...
Orden sin jerarquia. Cada uso elige uno.
...
| merecer | Obtener por merito |
| conseguir | Alcanzar lo buscado con esfuerzo |
| triunfar | Llegar al exito en lo emprendido |
| vencer | Superar resistencia o adversario |
| cobrar | Recibir lo que corresponde |
| conquistar | Tomar con decision |
| ceder | Ceder terreno |
| capitular | Rendirse formalmente |
| renunciar | Abandonar antes de disputar |
| fracasar | Quedar alejado del objetivo |
...
**Antonimos de ganar?**
ceder, capitular, renunciar, fracasar, sucumbir, perder.

## Enlaces

- https://ganar.com.ar — pagina principal
- https://ganar.com.ar/ganar.md — este archivo (referencia canonica)
- https://ganar.com.ar/skill.md — skill para agentes
- https://ganar.com.ar/spec.md — especificacion del sitio
- https://ganar.com.ar/llms.txt — resumen para LLM
- https://ganar.com.ar/humans.txt — informacion para humanos
- https://ganar.com.ar/sitemap.xml — mapa del sitio
